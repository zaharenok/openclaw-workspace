#!/usr/bin/env python3
"""
OpenClaw Webhook Server (Simple HTTP version)
...
# Configuration
WEBHOOK_PORT = int(os.getenv("WEBHOOK_PORT", "5679"))
    ...
    def do_GET(self):
        ...
        if self.path == '/':
            ...
            self.wfile.write(json.dumps({
                "status": "running",
                "service": "OpenClaw Webhook Server",
...
def run_server():
    ...
    print(f"🚀 OpenClaw Webhook Server starting on port {WEBHOOK_PORT}")
